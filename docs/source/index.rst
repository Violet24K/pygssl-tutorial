...
properties, as it contains many self-supervised algorithms:
   ...
   **Node-level Algorithms for General Graphs**: `DGI <https://arxiv.org/pdf/1809.10341.pdf>`_, `GraphCL <https://proceedings.nips.cc/paper/2020/file/3fe230348e9a12c13120749e3f9fa4cd-Paper.pdf>`_, 
   `MVGRL <https://proceedings.mlr.press/v119/hassani20a/hassani20a.pdf>`_, `GCA <https://arxiv.org/abs/2010.14945>`_,
